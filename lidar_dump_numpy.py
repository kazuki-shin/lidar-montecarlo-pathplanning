...
package_path='/home/dev/dp_stuff/site-packages35'                       # -- change this path
#package_path='/home/dev/dp_stuff/ubutu_package'
#sys.path.insert(0,package_path)
#package_path='/home/dev/dp_stuff/site-packages35_tf112'
sys.path.insert(0,package_path)
...
lidar_dir = '/home/dev/dp_stuff/data'                                   # -- change this path
